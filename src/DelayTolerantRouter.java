					...
					*/
						...
						else
						{
							...
							if(dest.equalsIgnoreCase("DA"))	
							{
								...
								Socket st1=new Socket("localhost",4561);  //Destination A
							...
							if(dest.equalsIgnoreCase("DB"))
							{
								...
								Socket st55=new Socket("localhost",4562);   //Destination B
							...
							if(dest.equalsIgnoreCase("DC"))
							{
								...
								Socket st3=new Socket("localhost",4563);    //Destination C
							...
							if(dest.equalsIgnoreCase("DD"))
							{
								...
								Socket st4=new Socket("localhost",4564);     //Destination D
